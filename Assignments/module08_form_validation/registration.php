         ...
         <div class="row">
            ...
            <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
             <div class="row">
                 ...
                 <div class="col-md-10">
                  <input type="text" name="user_name" value="" placeholder="Enter your First name" class="form-control" required="First name is required">
            ...
            <label class="label col-md-2 control-label">Last Name</label>
              <div class="col-md-10">
                <input type="text" class="form-control"  placeholder="Enter your last name" name="last_name" required="Last name is required" >
                </div>
             </div>
             ...
             <div class="row">
                 ...
                 <div class="col-md-10">
                 <input type="password" class="form-control"  placeholder="Confirm Password" name="psw_repeat" required="Re-enter password">
                 ...
                 if(isset($_POST['submit']))
                  {
					...
					$frname = clean_text($username);
                    if(!preg_match("/^[a-zA-Z ]*$/",$frname)){
                     ...
                     if($password==$confirmpass)
                    {
                      ...
                      if(mysqli_num_rows($query_run)>0)
                      {
                        ...
                        $sqlcheck = "INSERT INTO user_table(user_frname,user_lname,user_email,user_password,status,created_date,updated_date) 
                        VALUES('$frname','$last_name','$email','$password',1,'$current_time','$current_time')";
                        $query_run = mysqli_query($link,$sqlcheck); 
                        if($query_run)
                            {
                               echo '<script type="text/javascript"> alert("User Registered") </script>';  
                               $_SESSION['username']=$frname;
